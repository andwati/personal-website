...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://andwati.xyz</loc>
  </url>
  <url>
    <loc>https://andwati.xyz/writing</loc>
  </url>
  <url>
    <loc>https://andwati.xyz/engineering</loc>
  </url>
  <url>
    <loc>https://andwati.xyz/reading</loc>
  </url>
  <url>
    <loc>https://andwati.xyz/notes</loc>
  </url>${allSlugs
    .map((slug) => {
      return `
  <url>
    <loc>${`https://andwati.xyz${slug}`}</loc>
  </url>`;
    })
    .join("")}
</urlset>`;
